...
# 2.1 Into V 1.x
* [ ] Simulated environment : One smooth sphere 
* [ ] The entities change the color with selection
* [ ] Terminal for control command input
...
* [ ] The energy espenditure in a lifecycle of the entities is defined by:
  ...
  * [ ] Energy cost by Bulk
* [ ] The ligth origin rotates slowly around the map 
...
* [ ] AI neural network based for each entity
  ...
  * [ ] The data created by the entwork would be storaged for future use
